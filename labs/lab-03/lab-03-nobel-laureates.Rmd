...
author: Bale, Rolan, Alfred, Jack, Renee, Liz
output: 
  tufte::tufte_html:
...
_There are 935 observation and 26 variables within the data set. Each row represents the people who achieved a Nobel prize._
...
_There are 228 observation and 27 variables within the data set._ 
...
nobel_living_science %>%
  ...
  ggplot(data = nobel_living_science,
        mapping = aes (x=category, y=country_us))+
        facet_grid(~category)
        geom_bar()
```
